                ...
                <div class="row g-lg-5">
                    ...
                    <div class="col-lg-9">
                        <div class="content-box">
                            ...
                            @else
                                {{-- KHUSUS KOMISARIS & DIREKSI --}}
                                <div class="header-text-group mb-5 text-center">
                                    <h2 class="content-title mt-2">
                                        {{ $slug === 'komisaris' ? 'Dewan Komisaris' : 'Dewan Direksi' }}
                                    </h2>
                            ...
                            @elseif ($slug === 'visi-misi')
                                <div class="vision-mission-grid">
                                    ...
                                    <div class="mission-card">
                                        <h5 class="content-subtitle-inner">
                                            <i class="fas fa-rocket me-2"></i> Misi Kami
                                        </h5>
                            ...
                            @elseif ($slug === 'budaya')
                                <div class="culture-section">
                                    ...
                                    <div class="values-grid mt-5">
                                        <h5 class="content-subtitle-inner mb-4">
                                            <i class="fas fa-heart me-2"></i> Nilai-Nilai Budaya
                                        </h5>
                                        <div class="row">
                                    ...
                                    @foreach ($data['members'] as $member)
                                        <div class="commissioner-card">
                                            ...
                                            <div class="commissioner-info">
                                                ...
                                                <p>{{ $member['summary'] }}</p>
                                                <a href="{{ url('/perusahaan/komisaris/' . $member['slug']) }}"
                                                    class="btn-detail">
                                                    Selengkapnya
                                                </a>
                                            </div>
                                    ...
                                    @foreach ($data['members'] as $member)
                                        <div class="executive-card">
                                            ...
                                            <div class="executive-content">
                                                ...
                                                <p class="executive-excerpt">{{ $member['excerpt'] }}</p>
